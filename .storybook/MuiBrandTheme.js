...
export default create({
  ...
  brandTitle: 'Capital Sphere MUI theme design system',
  brandUrl: 'https://trade-sphere.com/assets/img/logo.png',
  brandImage: 'https://trade-sphere.com/assets/img/logo.png'
})
